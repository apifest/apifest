...
public class Mapping implements  Serializable {
    ...
    @XmlType
    static class EndpointsWrapper implements Serializable {
    ...
    @XmlType
    static class ActionsWrapper implements Serializable {
    ...
    @XmlType
    static class FiltersWrapper implements Serializable {
    ...
    @XmlType
    static class ErrorsWrapper implements Serializable {
